define([], function () {
    ...
    Calculator.prototype.nextMonth = function () {
        this.seedDate.setMonth(this.seedDate.getMonth() + 1);
        return this.calculate();
    };

    Calculator.prototype.lastMonth = function () {
        this.seedDate.setMonth(this.seedDate.getMonth() - 1);
        return this.calculate();
    };

    Calculator.prototype.nextWeek = function () {
        this.seedDate.setDate(this.seedDate.getDate() + 7);
        return this.calculate();
    };

    Calculator.prototype.lastWeek = function () {
        this.seedDate.setDate(this.seedDate.getDate() - 7);
        return this.calculate();
    };
